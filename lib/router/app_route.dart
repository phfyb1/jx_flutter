...
import '../binding/DangerSourceBinding.dart';
import '../pages/DangerSourcePage.dart';
...
abstract class AppRoutes {
  ...
  static const DangerSource = '/DangerSource'; // 重大危险源模板校验修复
  ...
  static final routes = [
    ...
    GetPage(
        name: DangerSource,
        page: () => DangerSourcePage(),
        binding: DangerSourceBinding()),
  ];
}
